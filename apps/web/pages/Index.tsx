        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="flex flex-col items-center text-center animate-fade-in max-w-3xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mb-10">
              Monitor your websites from multiple locations worldwide with our decentralized network of validators. Get instant alerts when things go wrong.
            </p>
          ...
          <div className="mt-16 max-w-4xl mx-auto animate-slide-up [animation-delay:300ms] z-1">
            <div className="rounded-lg border shadow-lg overflow-hidden bg-card">
              <div className="p-1 border-b bg-muted/30 flex items-center space-x-2 px-4">
                ...
                <div className="ml-2 text-xs text-muted-foreground">Wakey-Wakey Dashboard</div>
              </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                      <Card className="hover:shadow-md transition-all">
                        <CardContent className="p-6">
                          ...
                          <div className="text-sm text-muted-foreground mt-1">Average Uptime</div>
                        </CardContent>
                      </Card>
                      <Card className="hover:shadow-md transition-all">
                        <CardContent className="p-6">
                    ...
                    <Card className="hover:shadow-md transition-all">
                      <CardContent className="p-6">
                        <div className="flex items-center justify-between mb-4">
                          ...
                          <div className="text-xs text-muted-foreground">All times in ms</div>
                        </div>
                      ...
                      <CardContent className="p-6">
                        ...
                        <div className="space-y-4">
                          {[
                            ...
                            <div key={site.name} className="flex items-center justify-between border-b pb-2 last:border-0">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Reliable, accurate, and truly global website monitoring that never sleeps
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="relative">
              <div className="absolute -left-4 -top-4 w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center text-primary font-bold">1</div>
              <Card className="h-full">
                <CardContent className="p-6 pt-8">
                  <h3 className="text-xl font-semibold mb-4">Register Your Website</h3>
                  <p className="text-muted-foreground mb-4">Add your website to our platform and configure monitoring preferences.</p>
                  <ul className="space-y-2">
                    {["Easy setup", "Custom intervals", "Multiple endpoints"].map((item, i) => (
            ...
            <div className="relative">
              <div className="absolute -left-4 -top-4 w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center text-primary font-bold">2</div>
              <Card className="h-full">
                <CardContent className="p-6 pt-8">
                  <h3 className="text-xl font-semibold mb-4">Global Monitoring</h3>
                  <p className="text-muted-foreground mb-4">Our decentralized network of validators checks your website every 3 minutes from multiple locations.</p>
                  <ul className="space-y-2">
                    {["150+ global nodes", "Trustless validation", "Geographic diversity"].map((item, i) => (
                      <li key={i} className="flex items-center gap-2">
                        <CheckCircle className="h-4 w-4 text-green-500" />
                        <span>{item}</span>
                      </li>
            ...
            <div className="relative">
              <div className="absolute -left-4 -top-4 w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center text-primary font-bold">3</div>
              <Card className="h-full">
                <CardContent className="p-6 pt-8">
                  <h3 className="text-xl font-semibold mb-4">Real-time Insights</h3>
                  <p className="text-muted-foreground mb-4">Get alerts and detailed analytics about your website's performance and availability.</p>
                  <ul className="space-y-2">
                    {["Multi-channel alerts", "Performance trends", "Exportable reports"].map((item, i) => (
                      <li key={i} className="flex items-center gap-2">
                        <CheckCircle className="h-4 w-4 text-green-500" />
                        <span>{item}</span>
                      </li>
          ...
          <div className="flex flex-col md:flex-row gap-16 items-center">
            <div className="w-full md:w-1/2">
              ...
              <p className="text-lg text-muted-foreground mb-6">
                Join our network of validators and earn SOL for contributing your resources to monitor websites around the globe.
              </p>
            ...
            <div className="w-full md:w-1/2">
              <Card className="overflow-hidden">
                <div className="p-1 border-b bg-muted/30 flex items-center space-x-2 px-4">
                  ...
                  <div className="h-2.5 w-2.5 rounded-full bg-yellow-500"></div>
                  <div className="h-2.5 w-2.5 rounded-full bg-green-500"></div>
                  <div className="ml-2 text-xs text-muted-foreground">Validator Terminal</div>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card className="hover:shadow-lg transition-all relative border-primary">
              ...
              <CardContent className="p-6 pt-8">
                ...
                <div className="text-3xl font-bold mb-6">$19<span className="text-muted-foreground text-sm font-normal">/month</span></div>
                <div className="border-t border-b py-6 mb-6">
                  <ul className="space-y-4">
                    {[
                      "10 Websites",
            ...
            <Card className="hover:shadow-lg transition-all border-muted">
              <CardContent className="p-6 pt-8">
                ...
                <div className="text-3xl font-bold mb-6">$99<span className="text-muted-foreground text-sm font-normal">/month</span></div>
                <div className="border-t border-b py-6 mb-6">
                  <ul className="space-y-4">
                    {[
                      "Unlimited websites",
